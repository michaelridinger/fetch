<?
	...
	echo "<input type='hidden' name='suid' id='suid' value='".$catkey."'>";
	...
	$isbn=$_GET['isbn'];
	echo "<input type='hidden' name='isbnval' id='isbnval' value='".$isbn."'>";
	...
	$holdings.= "</td><td style='text-align:right;background-color:#404040;color:#FFF;>&nbsp;";
	if ($moreavail > 0) {
...
<?php
		...
		<div class='row' style='text-align:center'>
			...
			<div id="syndeticsUnboundContent<?php echo $_GET['id']; ?>"></div>
		</div>
	</div>
</div>
