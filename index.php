		  ...
		  <div class="modal-dialog modal-xl" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				...
				</td><td style='text-align:right;width:32px;padding:0px;'>
 <button type="button" class="btn btn-danger btn-sm rounded-circle d-flex align-items-center justify-content-center" style='box-shadow: 1px 1px 15px #00000030' 
                data-bs-dismiss="modal" aria-label="Close" style="width: 40px; height: 40px; line-height:40px;">
		<i class='fas fa-times' style='font-size:30px'></i>
        </button>
				</td></tr>
				</table>
			  </div>
			  <div class="modal-body" id='detailsModalBodyContainer'>
